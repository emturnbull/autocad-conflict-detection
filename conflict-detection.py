...
def convert(units, from_unit, to_unit='m'):
    """
    convert - converts units of measurement
    @inputparam: number of units
                 string containing base unit type
                 string containing desired unit type
    @outputparam: number of converted units
    """
    X_TO_METERS = {
        # Smart units
        'mm': 0.001,
...
if testing:
    ...
    geodatabase = 'C:\\Students\\100302933\\AECON\\AECON.gdb'
